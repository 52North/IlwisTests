...
void JulianTimeTests::conversions()
{
    ...
    QString s = t1.toString(false); // use UTC
...
void JulianTimeTests::timeInterval() {
    ...
    std::unique_ptr<Ilwis::TimeInterval> ti3(static_cast<Ilwis::TimeInterval *>(ti2.clone()));
    DOTEST(ti3->valueType() == itTIME && ti3->begin() == Ilwis::Time("12:30") && ti3->end() == Ilwis::Time("14:20"), "Testing cloning of timeinterval");
