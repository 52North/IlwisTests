...
REGISTER_TEST(VertexIteratorTests);

VertexIteratorTests::VertexIteratorTests():
    IlwisTestCase("VertexIteratorTests", "CoreTest")
{
}

void VertexIteratorTests::constructionTests()
{
    try{
...
void VertexIteratorTests::lineStringTests()
{
    try{
...
void VertexIteratorTests::pointTests()
{
    try{
...
void VertexIteratorTests::polygonTests()
{
    try{
